...
final labelTextStyle = GoogleFonts.poppins(
  color: AppPropertiesColor.black,
...
final transactionSuccessTextStyle = GoogleFonts.poppins(
  ...
  shadows: [
    Shadow(
      offset: Offset(2, 2),
      blurRadius: 4,
      color: AppPropertiesColor.black.withValues(alpha: 0.2),
    ),
  ],
);
...
final transactionSuccessPaidTextStyle = GoogleFonts.poppins(
  ...
  shadows: [
    Shadow(
      offset: Offset(2, 2),
      blurRadius: 4,
      color: AppPropertiesColor.primary.withValues(alpha: 0.4),
    ),
  ],
);
...
final textStyleItemCondiment = GoogleFonts.poppins(
  textStyle: TextStyle(
    backgroundColor: AppPropertiesColor.grey,
    color: AppPropertiesColor.white,
    fontWeight: FontWeight.w400,
    fontSize: 10,
  ),
...
final textStyleItemNormal = GoogleFonts.poppins(
  textStyle: const TextStyle(
    backgroundColor: AppPropertiesColor.primary,
    color: AppPropertiesColor.white,
    fontWeight: FontWeight.w400,
    fontSize: 10,
  ),
